...
des = 'FSI1' # design name (will be the prefix of the output file)
N_global = 100 # Number of unit cells
...
k = np.array([20_000, 100_000.*1.451, 100_000., 10_000., 10_000., 10_000., 10_000., 10_000.]) # for prob 4
...
m = np.array([1.e-7, 1.e-7, 5.e-7, 5.e-7, 5.e-7, 5.e-7]) # for prob 4

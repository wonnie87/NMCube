...
tEnd = 200.0 # end of simulation time
...
N_global = 99 # Number of unit cells
prob = ig.ProbType(2) # 1: 1D pendula chain, 2: 1D phi4 chain, 3: N/A, 4: bistable metabeam
...
udot0[0,0] = 1.0 # imposed initial velocity at the first unit

...
tEnd = 10.0 # end of simulation time
...
N_global = 5 # Number of unit cells
### If Prob_flag == 41, 42, 43, 44, or 45
NFE_perElem = 4
prob = ig.ProbType(45) # 1: 1D pendula chain, 2: 1D phi4 chain, 3: N/A, 4: bistable metabeam
...
s = np.array([1.241, 0.6*1.793, 0.6, 1500., 1500., 1500., 1500., 1500., 20., 40., 20., 8.]) # for prob 4
...
try:
    ig.DesignGen(sol_flag,des,N_global,prob,BC,s,m,b,LC,LC_val,u0,udot0, NFE_perElem)
except NameError:
    ig.DesignGen(sol_flag,des,N_global,prob,BC,s,m,b,LC,LC_val,u0,udot0)
    print(f" >> Parameter NFE_perElem is not provided. Make sure problem type is correct. Default value 2 will be used.")

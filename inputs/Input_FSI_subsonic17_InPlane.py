...
dtWrite = 1.0e-5 # file wirte frequency
...
des = 'subsonic17InPlane' # design name (will be the prefix of the output file)
N_global = 40 # Number of unit cells
...
### BC - Boundary condition ###
    ...
    ## Third digit (condition): 0-free, 1-fixed, 3-bottom fixed, 4-bottom roller
BC = np.array([100, 113, 124])
...
#s = np.array([3.3, 3.3, 3.3, 140000., 140000., 140000., 140000., 140000., 8., 10., 6., 1.6]) # for prob 4
s = np.array([3.3, 1.513*3.3, 3.3, 140000., 140000., 140000., 140000., 140000., 9., 11., 7., 1.8]) # for prob 4
...
LC = np.array([[1,1,13]]) # Load cases: [[UC, local DoF, Loadcase], ... ]
amp = 1.9
freqIn = 1.0
phi0 = 0.0
t1 = 0.0
...
#LC = np.array([[1,1,9]]) # Load cases: [[UC, local DoF, Loadcase], ... ]
#amp = 0.06
#freqIn = 190.0
#phi0 = 0.0
#t1 = 0.0
...
m = np.array([2.e-7, 2.e-7, 1.e-7, 1.e-7, 1.e-7, 1.e-7]) # for prob 4
...
b = 2*0.001*2*np.pi*1000*m # for prob 4

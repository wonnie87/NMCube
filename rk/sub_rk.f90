...
contains
    ...
    if (BC_flag == 100) then
        ...
        f(2) = p(1) + (-(s(62)**2*(6*s(4)*x(0) + s(29)*x(0)**3 + 6*beta(1)*m(1)*x(1) + x(4)*(6*s(5) + 3*s(30)&
            &*x(0)**2 + 3*s(32)*x(0)*x(4) + s(34)*x(4)**2) + 3*(2*s(6) + s(31)*x(0)**2)*x(8) + 3*s(33)*x(0)*x(8)*&
            &*2 + s(35)*x(8)**3)) + 6*s(24)*(x(-12) - 2*x(0) + x(12)))/(6.*s(62)**2)
        ...
        f(6) = (48*p(3) - 48*s(5)*x(0) - 8*s(30)*x(0)**3 - 48*s(10)*x(4) - 24*s(32)*x(0)**2*x(4) - 24&
            &*s(34)*x(0)*x(4)**2 - 8*s(36)*x(4)**3 - 48*beta(1)*m(3)*x(5) - 48*s(11)*x(8) - 24*s(37)*x(4)**2*x(8)&
            &- 24*s(40)*x(4)*x(8)**2 - 8*s(45)*x(8)**3 + (48*s(25)*(x(-8) - 2*x(4) + x(16)))/s(62)**2 + (24*s(12)&
            &*(x(-6) - x(18)))/s(62) + (12*s(38)*x(4)**2*(x(-6) - x(18)))/s(62) + (24*s(41)*x(4)*x(8)*(x(-6) - x(&
            &18)))/s(62) + (12*s(46)*x(8)**2*(x(-6) - x(18)))/s(62) - (6*s(43)*x(4)*(x(-6) - x(18))**2)/s(62)**2 &
            &- (6*s(48)*x(8)*(x(-6) - x(18))**2)/s(62)**2 + (s(50)*(x(-6) - x(18))**3)/s(62)**3 + (24*s(16)*(-x(-&
            &6) + x(18)))/s(62) + (24*s(13)*(x(-2) - x(22)))/s(62) + (12*s(39)*x(4)**2*(x(-2) - x(22)))/s(62) + (&
            &24*s(42)*x(4)*x(8)*(x(-2) - x(22)))/s(62) + (12*s(47)*x(8)**2*(x(-2) - x(22)))/s(62) - (6*s(44)*x(4)&
            &*(x(-2) - x(22))**2)/s(62)**2 - (6*s(49)*x(8)*(x(-2) - x(22))**2)/s(62)**2 + (s(51)*(x(-2) - x(22))*&
            &*3)/s(62)**3 + (24*s(22)*(-x(-2) + x(22)))/s(62))/48.

        f(7) = x(7)
        
        f(8) = (16*p(4) - 16*s(2) - 16*s(8)*x(2) - 16*s(14)*x(6) - 16*beta(1)*m(4)*x(7) - 16*s(15)*x(&
            &10) + (8*s(16)*(x(-8) - x(16)))/s(62) + (8*s(12)*(-x(-8) + x(16)))/s(62) + (4*s(38)*x(4)**2*(-x(-8) &
            &+ x(16)))/s(62) + (8*s(41)*x(4)*x(8)*(-x(-8) + x(16)))/s(62) + (4*s(46)*x(8)**2*(-x(-8) + x(16)))/s(&
            &62) + (4*s(43)*x(4)*(x(-8) - x(16))*(x(-6) - x(18)))/s(62)**2 + (4*s(48)*x(8)*(x(-8) - x(16))*(x(-6)&
            &- x(18)))/s(62)**2 + (s(50)*(-x(-8) + x(16))*(x(-6) - x(18))**2)/s(62)**3 + (16*s(26)*(x(-6) - 2*x(6&
            &) + x(18)))/s(62)**2 + (8*s(43)*x(4)**2*(x(-6) - 2*x(6) + x(18)))/s(62)**2 + (16*s(48)*x(4)*x(8)*(x(&
            &-6) - 2*x(6) + x(18)))/s(62)**2 + (8*s(55)*x(8)**2*(x(-6) - 2*x(6) + x(18)))/s(62)**2 + (2*s(59)*(x(&
            &-6) - x(18))**2*(x(-6) - 2*x(6) + x(18)))/s(62)**4 + (8*s(50)*x(4)*(-x(-6) + x(18))*(x(-6) - 2*x(6) &
            &+ x(18)))/s(62)**3 + (8*s(57)*x(8)*(-x(-6) + x(18))*(x(-6) - 2*x(6) + x(18)))/s(62)**3 + (8*s(17)*(x&
            &(-4) - x(20)))/s(62) + (4*s(48)*x(4)*(x(-6) - x(18))*(x(-4) - x(20)))/s(62)**2 + (4*s(55)*x(8)*(x(-6&
            &) - x(18))*(x(-4) - x(20)))/s(62)**2 + (8*s(19)*(-x(-4) + x(20)))/s(62) + (4*s(41)*x(4)**2*(-x(-4) +&
            &x(20)))/s(62) + (8*s(46)*x(4)*x(8)*(-x(-4) + x(20)))/s(62) + (4*s(53)*x(8)**2*(-x(-4) + x(20)))/s(62&
            &) + (s(57)*(x(-6) - x(18))**2*(-x(-4) + x(20)))/s(62)**3)/16.
        ...
        f(10) = (48*p(5) - 48*s(6)*x(0) - 8*s(31)*x(0)**3 - 48*s(11)*x(4) - 8*s(37)*x(4)**3 - 48*s(18&
            ...
            &*2 - 8*s(52)*x(8)**3 - 48*beta(1)*m(5)*x(9) + (24*s(19)*(x(-6) - x(18)))/s(62) + (12*s(41)*x(4)**2*(&
            &x(-6) - x(18)))/s(62) + (24*s(46)*x(4)*x(8)*(x(-6) - x(18)))/s(62) + (12*s(53)*x(8)**2*(x(-6) - x(18&
            &)))/s(62) - (6*s(48)*x(4)*(x(-6) - x(18))**2)/s(62)**2 - (6*s(55)*x(8)*(x(-6) - x(18))**2)/s(62)**2 &
            &+ (s(57)*(x(-6) - x(18))**3)/s(62)**3 + (24*s(17)*(-x(-6) + x(18)))/s(62) + (48*s(27)*(x(-4) - 2*x(8&
            &) + x(20)))/s(62)**2 + (24*s(20)*(x(-2) - x(22)))/s(62) + (12*s(42)*x(4)**2*(x(-2) - x(22)))/s(62) +&
            &(24*s(47)*x(4)*x(8)*(x(-2) - x(22)))/s(62) + (12*s(54)*x(8)**2*(x(-2) - x(22)))/s(62) - (6*s(49)*x(4&
            &)*(x(-2) - x(22))**2)/s(62)**2 - (6*s(56)*x(8)*(x(-2) - x(22))**2)/s(62)**2 + (s(58)*(x(-2) - x(22))&
            &**3)/s(62)**3 + (24*s(23)*(-x(-2) + x(22)))/s(62))/48.

        f(11) = x(11)

        f(12) = (16*p(6) - 16*s(3) - 16*s(9)*x(2) - 16*s(15)*x(6) - 16*s(21)*x(10) - 16*beta(1)*m(6)*&
            &x(11) + (8*s(22)*(x(-8) - x(16)))/s(62) + (8*s(13)*(-x(-8) + x(16)))/s(62) + (4*s(39)*x(4)**2*(-x(-8&
            &) + x(16)))/s(62) + (8*s(42)*x(4)*x(8)*(-x(-8) + x(16)))/s(62) + (4*s(47)*x(8)**2*(-x(-8) + x(16)))/&
            &s(62) + (8*s(23)*(x(-4) - x(20)))/s(62) + (8*s(20)*(-x(-4) + x(20)))/s(62) + (4*s(42)*x(4)**2*(-x(-4&
            &) + x(20)))/s(62) + (8*s(47)*x(4)*x(8)*(-x(-4) + x(20)))/s(62) + (4*s(54)*x(8)**2*(-x(-4) + x(20)))/&
            &s(62) + (4*s(44)*x(4)*(x(-8) - x(16))*(x(-2) - x(22)))/s(62)**2 + (4*s(49)*x(8)*(x(-8) - x(16))*(x(-&
            &2) - x(22)))/s(62)**2 + (4*s(49)*x(4)*(x(-4) - x(20))*(x(-2) - x(22)))/s(62)**2 + (4*s(56)*x(8)*(x(-&
            &4) - x(20))*(x(-2) - x(22)))/s(62)**2 + (s(51)*(-x(-8) + x(16))*(x(-2) - x(22))**2)/s(62)**3 + (s(58&
            &)*(-x(-4) + x(20))*(x(-2) - x(22))**2)/s(62)**3 + (16*s(28)*(x(-2) - 2*x(10) + x(22)))/s(62)**2 + (8&
            &*s(44)*x(4)**2*(x(-2) - 2*x(10) + x(22)))/s(62)**2 + (16*s(49)*x(4)*x(8)*(x(-2) - 2*x(10) + x(22)))/&
            &s(62)**2 + (8*s(56)*x(8)**2*(x(-2) - 2*x(10) + x(22)))/s(62)**2 + (2*s(60)*(x(-2) - x(22))**2*(x(-2)&
            &- 2*x(10) + x(22)))/s(62)**4 + (8*s(51)*x(4)*(-x(-2) + x(22))*(x(-2) - 2*x(10) + x(22)))/s(62)**3 + &
            &(8*s(58)*x(8)*(-x(-2) + x(22))*(x(-2) - 2*x(10) + x(22)))/s(62)**3)/16.
        ...
        f(2) = p(1) - s(4)*x(0) - (s(29)*x(0)**3)/6. - beta(1)*m(1)*x(1) + (s(24)*(-x(0) + x(12)))/s(62)**2
        ...
        f(2) = p(1) + (6*s(24)*(x(-12) - x(0)) - s(62)**2*(6*s(4)*x(0) + s(29)*x(0)**3 + 6*beta(1)*m(&
            &1)*x(1) + x(4)*(6*s(5) + 3*s(30)*x(0)**2 + 3*s(32)*x(0)*x(4) + s(34)*x(4)**2) + 3*(2*s(6) + s(31)*x(&
            &0)**2)*x(8) + 3*s(33)*x(0)*x(8)**2 + s(35)*x(8)**3))/(6.*s(62)**2)
        ...
        f(6) = (48*p(3) - 48*s(5)*x(0) - 8*s(30)*x(0)**3 + (48*s(25)*(x(-8) - x(4)))/s(62)**2 - 48*s(&
            &10)*x(4) - 24*s(32)*x(0)**2*x(4) - 24*s(34)*x(0)*x(4)**2 - 8*s(36)*x(4)**3 - 48*beta(1)*m(3)*x(5) + &
            &(24*s(12)*(x(-6) - x(6)))/s(62) + (12*s(38)*x(4)**2*(x(-6) - x(6)))/s(62) - (6*s(43)*x(4)*(x(-6) - x&
            &(6))**2)/s(62)**2 + (s(50)*(x(-6) - x(6))**3)/s(62)**3 + (24*s(16)*(-x(-6) + x(6)))/s(62) - 48*s(11)&
            &*x(8) - 24*s(37)*x(4)**2*x(8) + (24*s(41)*x(4)*(x(-6) - x(6))*x(8))/s(62) - (6*s(48)*(x(-6) - x(6))*&
            &*2*x(8))/s(62)**2 - 24*s(40)*x(4)*x(8)**2 + (12*s(46)*(x(-6) - x(6))*x(8)**2)/s(62) - 8*s(45)*x(8)**&
            &3 + (24*s(13)*(x(-2) - x(10)))/s(62) + (12*s(39)*x(4)**2*(x(-2) - x(10)))/s(62) + (24*s(42)*x(4)*x(8&
            &)*(x(-2) - x(10)))/s(62) + (12*s(47)*x(8)**2*(x(-2) - x(10)))/s(62) - (6*s(44)*x(4)*(x(-2) - x(10))*&
            &*2)/s(62)**2 - (6*s(49)*x(8)*(x(-2) - x(10))**2)/s(62)**2 + (s(51)*(x(-2) - x(10))**3)/s(62)**3 + (2&
            &4*s(22)*(-x(-2) + x(10)))/s(62))/48.

        f(7) = x(7)

        f(8) = (16*p(4) - 16*s(2) - 16*s(8)*x(2) + (8*s(16)*(x(-8) - x(4)))/s(62) + (8*s(12)*(-x(-8) &
            &+ x(4)))/s(62) + (4*s(38)*x(4)**2*(-x(-8) + x(4)))/s(62) + (16*s(26)*(x(-6) - x(6)))/s(62)**2 + (4*s&
            &(43)*(x(-8) - x(4))*x(4)*(x(-6) - x(6)))/s(62)**2 + (8*s(43)*x(4)**2*(x(-6) - x(6)))/s(62)**2 - (s(5&
            &0)*(x(-8) - x(4))*(x(-6) - x(6))**2)/s(62)**3 - (8*s(50)*x(4)*(x(-6) - x(6))**2)/s(62)**3 + (2*s(59)&
            &*(x(-6) - x(6))**3)/s(62)**4 - 16*s(14)*x(6) - 16*beta(1)*m(4)*x(7) + (8*s(17)*(x(-4) - x(8)))/s(62)&
            &+ (4*s(48)*x(4)*(x(-6) - x(6))*(x(-4) - x(8)))/s(62)**2 - (s(57)*(x(-6) - x(6))**2*(x(-4) - x(8)))/s&
            &(62)**3 + (8*s(41)*x(4)*(-x(-8) + x(4))*x(8))/s(62) + (4*s(48)*(x(-8) - x(4))*(x(-6) - x(6))*x(8))/s&
            &(62)**2 + (16*s(48)*x(4)*(x(-6) - x(6))*x(8))/s(62)**2 - (8*s(57)*(x(-6) - x(6))**2*x(8))/s(62)**3 +&
            &(4*s(55)*(x(-6) - x(6))*(x(-4) - x(8))*x(8))/s(62)**2 + (4*s(46)*(-x(-8) + x(4))*x(8)**2)/s(62) + (8&
            &*s(55)*(x(-6) - x(6))*x(8)**2)/s(62)**2 + (8*s(19)*(-x(-4) + x(8)))/s(62) + (4*s(41)*x(4)**2*(-x(-4)&
            &+ x(8)))/s(62) + (8*s(46)*x(4)*x(8)*(-x(-4) + x(8)))/s(62) + (4*s(53)*x(8)**2*(-x(-4) + x(8)))/s(62)&
            &- 16*s(15)*x(10))/16.
        ...
        f(10) = (48*p(5) - 48*s(6)*x(0) - 8*s(31)*x(0)**3 - 48*s(11)*x(4) - 8*s(37)*x(4)**3 + (24*s(1&
            ...
            &*s(45)*x(4)*x(8)**2 + (12*s(53)*(x(-6) - x(6))*x(8)**2)/s(62) - 8*s(52)*x(8)**3 - 48*beta(1)*m(5)*x(&
            &9) + (24*s(20)*(x(-2) - x(10)))/s(62) + (12*s(42)*x(4)**2*(x(-2) - x(10)))/s(62) + (24*s(47)*x(4)*x(&
            &8)*(x(-2) - x(10)))/s(62) + (12*s(54)*x(8)**2*(x(-2) - x(10)))/s(62) - (6*s(49)*x(4)*(x(-2) - x(10))&
            &**2)/s(62)**2 - (6*s(56)*x(8)*(x(-2) - x(10))**2)/s(62)**2 + (s(58)*(x(-2) - x(10))**3)/s(62)**3 + (&
            &24*s(23)*(-x(-2) + x(10)))/s(62))/48.

        f(11) = x(11)

        f(12) = (16*p(6) - 16*s(3) - 16*s(9)*x(2) + (8*s(22)*(x(-8) - x(4)))/s(62) + (8*s(13)*(-x(-8)&
            &+ x(4)))/s(62) + (4*s(39)*x(4)**2*(-x(-8) + x(4)))/s(62) - 16*s(15)*x(6) + (8*s(23)*(x(-4) - x(8)))/&
            &s(62) + (8*s(42)*x(4)*(-x(-8) + x(4))*x(8))/s(62) + (4*s(47)*(-x(-8) + x(4))*x(8)**2)/s(62) + (8*s(2&
            &0)*(-x(-4) + x(8)))/s(62) + (4*s(42)*x(4)**2*(-x(-4) + x(8)))/s(62) + (8*s(47)*x(4)*x(8)*(-x(-4) + x&
            &(8)))/s(62) + (4*s(54)*x(8)**2*(-x(-4) + x(8)))/s(62) + (16*s(28)*(x(-2) - x(10)))/s(62)**2 + (4*s(4&
            &4)*(x(-8) - x(4))*x(4)*(x(-2) - x(10)))/s(62)**2 + (8*s(44)*x(4)**2*(x(-2) - x(10)))/s(62)**2 + (4*s&
            &(49)*x(4)*(x(-4) - x(8))*(x(-2) - x(10)))/s(62)**2 + (4*s(49)*(x(-8) - x(4))*x(8)*(x(-2) - x(10)))/s&
            &(62)**2 + (16*s(49)*x(4)*x(8)*(x(-2) - x(10)))/s(62)**2 + (4*s(56)*(x(-4) - x(8))*x(8)*(x(-2) - x(10&
            &)))/s(62)**2 + (8*s(56)*x(8)**2*(x(-2) - x(10)))/s(62)**2 - (s(51)*(x(-8) - x(4))*(x(-2) - x(10))**2&
            &)/s(62)**3 - (8*s(51)*x(4)*(x(-2) - x(10))**2)/s(62)**3 - (s(58)*(x(-4) - x(8))*(x(-2) - x(10))**2)/&
            &s(62)**3 - (8*s(58)*x(8)*(x(-2) - x(10))**2)/s(62)**3 + (2*s(60)*(x(-2) - x(10))**3)/s(62)**4 - 16*s&
            &(21)*x(10) - 16*beta(1)*m(6)*x(11))/16.

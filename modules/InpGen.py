...
Vbar4th1555, Vbar4th3333, Vbar4th3335, Vbar4th3355, Vbar4th3555, \
Vbar4th5555, L1, h\n")
...
(-3*s[1]*np.sqrt(s[9]**2 + s[11]**2))/(s[8]*s[9]**3),\
(-3*s[2]*np.sqrt(s[10]**2 + s[11]**2))/(s[8]*s[10]**3),\
(3*(s[5]*s[9]**3 + 2*s[6]*s[9]**3 + s[1]*(s[9] + s[10])**2*np.sqrt(s[9]**2 + s[11]**2)))/(s[8]*s[9]**3*(s[9] + s[10])**2),\
(-3*(s[5] + 2*s[6]))/(s[8]*(s[9] + s[10])**2),\
(3*(s[5] + 2*s[6]))/(s[8]*(s[9] + s[10])**2),\
(-3*(s[5] + 2*s[6]))/(s[8]*(s[9] + s[10])**2),\
(3*(s[5]*s[10]**3 + 2*s[6]*s[10]**3 + s[2]*(s[9] + s[10])**2*np.sqrt(s[10]**2 + s[11]**2)))/(s[8]*s[10]**3*(s[9] + s[10])**2),\
s[8],\
s[8]/NFE_perElem \
))
